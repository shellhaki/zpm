...
zpm tui             # open the animated dashboard
...
<CardGrid stagger>
  ...
  <Card title="Terminal dashboard" icon="desktop">
    Use `zpm tui`, `zpm ui`, or `zpm tux` for an animated live dashboard that adapts to compact and wide terminals.
  </Card>
...
The live dashboard refreshes process status, animates daemon activity, and keeps the layout usable from narrow split panes to wide terminals.
